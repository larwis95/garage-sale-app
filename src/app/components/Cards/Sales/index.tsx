...
export default function SalesCard({ title, startDate, endDate, location, description, _id }: ISalesCardProps) {
  return (
    <motion.div className="min-w-full md:min-w-1/2 lg:min-w-1/4 m-2 flex flex-col  justify-around rounded-lg border border-teal-500 bg-slate-800 shadow-md" initial={{ opacity: 0 }} whileInView={{ opacity: 1 }} exit={{ scale: 0, opacity: 0 }} transition={{ duration: 0.5 }}>
