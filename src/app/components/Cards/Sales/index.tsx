...
export default function SalesCard({ title, startDate, endDate, location, description, _id }: ISalesCardProps) {
  return (
    <motion.div className="m-2 flex flex-col justify-around rounded-lg border border-white bg-slate-800 shadow-md" initial={{ opacity: 0 }} whileInView={{ opacity: 1 }} exit={{ scale: 0, opacity: 0 }} transition={{ duration: 0.5 }}>
