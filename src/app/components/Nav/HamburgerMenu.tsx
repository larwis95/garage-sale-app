...
export default function HamburgerMenu() {
  return (
    <motion.div className={`h-50svh w-50svw absolute flex flex-col justify-start gap-2 rounded-r-lg border-b border-r border-t border-yellow-300 bg-teal-200 bg-opacity-65 p-2 align-middle backdrop-blur-sm`} initial={{ x: "-100vw" }} animate={{ x: 0 }} exit={{ x: "-100vw" }} transition={{ duration: 0.5 }}>
