...
const AddItemModal = forwardRef<HTMLDivElement, IAddItemModal>(function AddItemModal({ setIsOpen }, ref) {
  ...
  return (
    <div className="absolute left-0 top-0 z-50 flex h-full w-full flex-col items-center justify-center bg-black bg-opacity-50 backdrop-blur-sm">
      <motion.div initial={{ x: "-100vw" }} animate={{ x: 0 }} exit={{ opacity: 0 }} className="relative z-50 flex flex-col items-center justify-center gap-4 rounded-lg border border-yellow-300 bg-slate-600 bg-opacity-55 p-6 backdrop-blur-md" ref={ref}>
